...
단일 에이전트 설계와 업무 자동화 실습 자료입니다. 메인 페이지는 이유진 멘토 담당 PPT와 실습 워크시트로 바로 이동하는 자료 허브 역할만 합니다.
...
- **메인 허브** — 이유진 멘토 사례 PPT 2개와 실습 워크시트 바로가기
- **오전 멘토 PPT** — 문제 좁히기: 첫 번째 세부 과업 선정
- **오후 멘토 PPT** — 암묵지 형식화 + 스킬 개발 및 활용
- **실습 워크시트** — 문제 좁히기, 데이터 확보, 암묵지 형식화, 스킬 구축

## GitHub Pages 배포

1. 이 저장소를 GitHub에 push
2. Settings → Pages → Source: `main` 브랜치, `/` (root) 선택
3. 저장 후 잠시 기다리면 배포 완료
